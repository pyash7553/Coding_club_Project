            ...
            <nav className="navigation_bar">
                <div>
                    ...
                    <ul className={mobileMenu ? "horizontal_bar" : "horizontal_bar mobile-menu-icon"}>
                        ...
                        <li className={mobileMenu ? "liComponent" : "mobile-li"} id="contact"><a href="">CONTECT US</a></li>
                        <li className={mobileMenu ? "liComponent" : "mobile-li"} id="about"><a href="">ABOUT US</a></li>
                    </ul>
                </div>
