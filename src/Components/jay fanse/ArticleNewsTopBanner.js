...
import "bootstrap"
// import ArticleBanner from "./ArticleBanner.jpg"
        ...
        <div id="carouselExample" className="carousel slide CarouselStyle">
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="/images/ArticleBanner.jpg" className="d-block BannerIcon" alt="..." />
            </div>
            <div className="carousel-item">
              <img src="/images/NewsBanner.jpg" className="d-block BannerIcon " alt="..." />
            </div>
          </div>
          <button
